...
const rubik = Rubik({ subsets: ["hebrew"], weight: "500" });
  ...
  return (
    <div className="min-h-screen h-fit flex flex-col md:flex-row py-12 bg-gradient-to-b from-black via-black to-gray-700 bg-opacity-60">
      <div className="w-full flex flex-col items-center justify-center gap-4 px-12 text-white ">
        <h2 className={`text-[3em] font-bold ${rubik.className}`}>About</h2>
        <p className={`text-center leading-loose ${rubik.className}`}>
      ...
      <div className="w-full p-20">
        <div className="min-h-[300px] h-full bg-[url('https://images.pexels.com/photos/13583358/pexels-photo-13583358.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1280&dpr=1')] bg-cover"></div>
      </div>
    </div>
  );
}
